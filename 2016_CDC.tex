...
relation~\eqref{eq:conditionYEpsApproximation} holds if and only if 
\begin{equation}
...
\end{equation}
Finally, according to \cite[Eq.~(12)]{Rakovic2005}, the solution of~\eqref{eq:criticalAlphaApprox} evaluates to
$$
