...
$A=0.5$
and the constraints $\X=[-2,2]$ and $\W^\ast=[-1,1]$. This one-dimensional example (without state constraints) was also analyzed in \cite[Exmp.~6.10]{Blanchini2008}.

Since
$$
\epsilon \leq \frac{\hat{\alpha}^\ast}{\ub{\alpha}}-1  \leq \frac{\alpha^\ast}{\ub{\alpha}}-1,
$$
